...
export const enum_about_info_links_link_type = pgEnum('enum_about_info_links_link_type', [
  'reference',
  'custom',
])
export const enum_about_info_links_link_icon_type = pgEnum('enum_about_info_links_link_icon_type', [
  'none',
  'icon',
  'media',
])
export const enum_about_info_links_link_icon_position = pgEnum(
  'enum_about_info_links_link_icon_position',
  ['before', 'after'],
)
...
export const enum_main_menu_nav_items_link_icon_type = pgEnum(
  'enum_main_menu_nav_items_link_icon_type',
  ['none', 'icon', 'media'],
)
export const enum_main_menu_nav_items_link_icon_position = pgEnum(
  'enum_main_menu_nav_items_link_icon_position',
  ['before', 'after'],
)
...
export const pages = pgTable(
  ...
  (columns) => ({
    ...
    pages_path_idx: uniqueIndex('pages_path_idx').on(columns.path),
...
export const _pages_v = pgTable(
  '_pages_v',
  {
    ...
    version_path: varchar('version_path'),
  ...
  (columns) => ({
    ...
    _pages_v_version_version_path_idx: index('_pages_v_version_version_path_idx').on(
      columns.version_path,
    ),
...
export const users = pgTable(
  'users',
  {
    ...
    secondName: varchar('second_name').notNull(),
...
export const site_config = pgTable(
  ...
  {
    id: serial('id').primaryKey(),
    websiteTitle: varchar('website_title').notNull().default('Website Template'),
    websiteIcon: integer('website_icon_id').references(() => media.id, {
      onDelete: 'set null',
    }),
  ...
  (columns) => ({
    site_config_website_icon_idx: index('site_config_website_icon_idx').on(columns.websiteIcon),
    site_config_favicon_idx: index('site_config_favicon_idx').on(columns.favicon),
...
export const about_info_locations = pgTable(
  'about_info_locations',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('about_info_locations_order_idx').on(columns._order),
    _parentIDIdx: index('about_info_locations_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [about_info.id],
      name: 'about_info_locations_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const about_info_opening_hours = pgTable(
  'about_info_opening_hours',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    days: varchar('days').notNull(),
    times: varchar('times').notNull(),
  },
  (columns) => ({
    _orderIdx: index('about_info_opening_hours_order_idx').on(columns._order),
    _parentIDIdx: index('about_info_opening_hours_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [about_info.id],
      name: 'about_info_opening_hours_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const about_info_phones = pgTable(
  'about_info_phones',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('about_info_phones_order_idx').on(columns._order),
    _parentIDIdx: index('about_info_phones_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [about_info.id],
      name: 'about_info_phones_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const about_info_emails = pgTable(
  'about_info_emails',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('about_info_emails_order_idx').on(columns._order),
    _parentIDIdx: index('about_info_emails_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [about_info.id],
      name: 'about_info_emails_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const about_info_links = pgTable(
  'about_info_links',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type: enum_about_info_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    link_label: varchar('link_label'),
    link_icon_type: enum_about_info_links_link_icon_type('link_icon_type').default('none'),
    link_icon_position:
      enum_about_info_links_link_icon_position('link_icon_position').default('before'),
    link_icon_filled: boolean('link_icon_filled'),
    link_icon_size: numeric('link_icon_size').default('24'),
    link_icon_name: varchar('link_icon_name'),
    link_icon_media: integer('link_icon_media_id').references(() => media.id, {
      onDelete: 'set null',
    }),
  },
  (columns) => ({
    _orderIdx: index('about_info_links_order_idx').on(columns._order),
    _parentIDIdx: index('about_info_links_parent_id_idx').on(columns._parentID),
    about_info_links_link_icon_link_icon_media_idx: index(
      'about_info_links_link_icon_link_icon_media_idx',
    ).on(columns.link_icon_media),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [about_info.id],
      name: 'about_info_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const about_info = pgTable('about_info', {
  id: serial('id').primaryKey(),
  updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 }),
  createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 }),
})

export const about_info_rels = pgTable(
  'about_info_rels',
  {
    id: serial('id').primaryKey(),
    order: integer('order'),
  ...
  (columns) => ({
    order: index('about_info_rels_order_idx').on(columns.order),
    parentIdx: index('about_info_rels_parent_idx').on(columns.parent),
    pathIdx: index('about_info_rels_path_idx').on(columns.path),
    about_info_rels_pages_id_idx: index('about_info_rels_pages_id_idx').on(columns.pagesID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [about_info.id],
      name: 'about_info_rels_parent_fk',
    }).onDelete('cascade'),
    pagesIdFk: foreignKey({
      columns: [columns['pagesID']],
      foreignColumns: [pages.id],
      name: 'about_info_rels_pages_fk',
    }).onDelete('cascade'),
  }),
)
...
export const main_menu_nav_items = pgTable(
  'main_menu_nav_items',
  {
    ...
    link_url: varchar('link_url'),
    link_label: varchar('link_label'),
    link_icon_type: enum_main_menu_nav_items_link_icon_type('link_icon_type').default('none'),
    link_icon_position:
      enum_main_menu_nav_items_link_icon_position('link_icon_position').default('before'),
    link_icon_filled: boolean('link_icon_filled'),
    link_icon_size: numeric('link_icon_size').default('24'),
    link_icon_name: varchar('link_icon_name'),
    link_icon_media: integer('link_icon_media_id').references(() => media.id, {
  ...
  (columns) => ({
    ...
    main_menu_nav_items_link_icon_link_icon_media_idx: index(
      'main_menu_nav_items_link_icon_link_icon_media_idx',
    ).on(columns.link_icon_media),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
...
export const footer = pgTable('footer', {
  id: serial('id').primaryKey(),
  showAboutInfo: boolean('show_about_info').default(true),
  copyright_showCopyright: boolean('copyright_show_copyright').notNull().default(true),
  copyright_entity: varchar('copyright_entity').default('Fear Indigo'),
  showMadeByLink: boolean('show_made_by_link').notNull().default(true),
  updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 }),
  createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 }),
})
...
export const relations_site_config = relations(site_config, ({ one, many }) => ({
  websiteIcon: one(media, {
    fields: [site_config.websiteIcon],
    references: [media.id],
    relationName: 'websiteIcon',
  }),
  favicon: one(media, {
...
export const relations_about_info_locations = relations(about_info_locations, ({ one }) => ({
  _parentID: one(about_info, {
    fields: [about_info_locations._parentID],
    references: [about_info.id],
    relationName: 'locations',
  }),
}))
export const relations_about_info_opening_hours = relations(
  about_info_opening_hours,
  ({ one }) => ({
    _parentID: one(about_info, {
      fields: [about_info_opening_hours._parentID],
      references: [about_info.id],
      relationName: 'openingHours',
    }),
  }),
)
export const relations_about_info_phones = relations(about_info_phones, ({ one }) => ({
  _parentID: one(about_info, {
    fields: [about_info_phones._parentID],
    references: [about_info.id],
    relationName: 'phones',
  }),
}))
export const relations_about_info_emails = relations(about_info_emails, ({ one }) => ({
  _parentID: one(about_info, {
    fields: [about_info_emails._parentID],
    references: [about_info.id],
    relationName: 'emails',
  }),
}))
export const relations_about_info_links = relations(about_info_links, ({ one }) => ({
  _parentID: one(about_info, {
    fields: [about_info_links._parentID],
    references: [about_info.id],
    relationName: 'links',
  }),
  link_icon_media: one(media, {
    fields: [about_info_links.link_icon_media],
    references: [media.id],
    relationName: 'link_icon_media',
  }),
}))
export const relations_about_info_rels = relations(about_info_rels, ({ one }) => ({
  parent: one(about_info, {
    fields: [about_info_rels.parent],
    references: [about_info.id],
    relationName: '_rels',
  }),
  pagesID: one(pages, {
    fields: [about_info_rels.pagesID],
    references: [pages.id],
    relationName: 'pages',
  }),
}))
export const relations_about_info = relations(about_info, ({ many }) => ({
  locations: many(about_info_locations, {
    relationName: 'locations',
  }),
  openingHours: many(about_info_opening_hours, {
    relationName: 'openingHours',
  }),
  phones: many(about_info_phones, {
    relationName: 'phones',
  }),
  emails: many(about_info_emails, {
    relationName: 'emails',
  }),
  links: many(about_info_links, {
    relationName: 'links',
  }),
  _rels: many(about_info_rels, {
    relationName: '_rels',
  }),
}))
export const relations_main_menu_nav_items = relations(main_menu_nav_items, ({ one }) => ({
  ...
  link_icon_media: one(media, {
    fields: [main_menu_nav_items.link_icon_media],
    references: [media.id],
    relationName: 'link_icon_media',
  }),
}))
...
type DatabaseSchema = {
  ...
  enum_about_info_links_link_type: typeof enum_about_info_links_link_type
  enum_about_info_links_link_icon_type: typeof enum_about_info_links_link_icon_type
  enum_about_info_links_link_icon_position: typeof enum_about_info_links_link_icon_position
  enum_main_menu_nav_items_link_type: typeof enum_main_menu_nav_items_link_type
  enum_main_menu_nav_items_link_icon_type: typeof enum_main_menu_nav_items_link_icon_type
  enum_main_menu_nav_items_link_icon_position: typeof enum_main_menu_nav_items_link_icon_position
  ...
  about_info_locations: typeof about_info_locations
  about_info_opening_hours: typeof about_info_opening_hours
  about_info_phones: typeof about_info_phones
  about_info_emails: typeof about_info_emails
  about_info_links: typeof about_info_links
  about_info: typeof about_info
  about_info_rels: typeof about_info_rels
  ...
  relations_about_info_locations: typeof relations_about_info_locations
  relations_about_info_opening_hours: typeof relations_about_info_opening_hours
  relations_about_info_phones: typeof relations_about_info_phones
  relations_about_info_emails: typeof relations_about_info_emails
  relations_about_info_links: typeof relations_about_info_links
  relations_about_info_rels: typeof relations_about_info_rels
  relations_about_info: typeof relations_about_info
